...
public class UsersController {
    ...
    public String register(@ModelAttribute @Valid Users user, BindingResult bindingResult) throws IOException, InvocationTargetException, IllegalAccessException {
